  ...
  return (
    <section className='section-page-mission'>
      ...
      <article className='mission-container1'>
        <h2 className='bold titre-mission-1'>Nos Missions</h2>
        <div className='mission-content'>
          <div className='mission-text'>
            <p>
              <span className='font-gray one4all-font'>#One4All</span> porte son
              regard sur le monde et ses enjeux en militant activement dans
      ...
      <article className='mission-container2'>
        <div className='mission-content2'>
          <h2 className='bold'>
            Découvrir les prochaines missions{' '}
            <span className='font-gray one4all-font'>#One4All</span> en 2022 :
          </h2>
      ...
      <article className='mission-container3'>
        <p>
          <span className='font-gray one4all-font'>#One4All</span> est
          actuellement dans sa phase de structuration pour ensuite passer au
          développement puis au lancement.
        </p>
        <div className='mission-image3'>
          <img className='img' src='./assets/missions/thermo-copie.png' />
        </div>
        <p>
          Vous êtes libres de participer à la construction de{' '}
          <span className='font-gray one4all-font'>#One4All</span>, d’aider à
          son développement ou encore de vous engager à nos côtés au sein de
          notre structure.
        </p>
