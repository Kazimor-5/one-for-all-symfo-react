      ...
      <section className='section-nos-activites-comm' style={myStyle}>
        ...
        <article className='activites-content1'>
          ...
          <div className='paragraph-activite1'>
            ...
            <h3 className='capital-activites'>
              épicurien, fashion et altruiste...
            </h3>
            <h3>Le mantra de la marque au 3ème oeil.</h3>
            <br />
            <h3 style={{ marginTop: -10 }}>
              Apprètez-vous à changer de dimension !!!
            </h3>
          </div>
        </article>
        <article className='wrap'>
          <article className='activites-content2'>
            ...
            <div className='paragraph-activite2'>
              <p>
                Choisir #ONE-<span className='store-font-yellow'>IV</span>-ALL
                California c’est faire le choix de vous faire plaisir en
                soutenant une cause.
              </p>
              <p>
                Grâce à #ONE-<span className='store-font-yellow'>IV</span>-ALL
                California, la consommation n’est plus une finalité mais un
                moyen de financer des actions altruistes.
              </p>
              <button className='btn lien-one4all-california'>
                <a href='https://www.one4all-california.world/'>
                  {' '}
                  www.one4all-california.world/
                </a>
              </button>
            </div>
          </article>
