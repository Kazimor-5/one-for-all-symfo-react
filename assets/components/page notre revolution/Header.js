...
import BtnUp from '../landing page/BtnUp';
...
const Header = () => {
    ...
    return (
        <div className='page-revolution' style={myStyle}>
            <div className='header-fixe header-revolution'>
                <img src={image} />
            </div>
            
                <section className='page-revolution-content'>
                    <article className='page-revolution-content1'>
                        ...
                        <div className='content-revolution1'>
                            <div className='abraham-img-container'>
                                <img className='img' src='./assets/revolution/Abraham-circle.png'/>
                            </div>
                            <p>
                    ...
                    <article className='article-revolution-page page-revolution-content2'>
                        ...
                        <img className="img beer" src='./assets/revolution/d.jpg' />
                    </article>
                    <article className='article-revolution-page page-revolution-content3'>
                        ...
                        <img className='img' src='./assets/revolution/e.jpg' />
                    </article>
                    <article className='article-revolution-page page-revolution-content4'>
                        ...
                        <img className='img don-v' src='./assets/revolution/DV-lowPoly.png'/>
